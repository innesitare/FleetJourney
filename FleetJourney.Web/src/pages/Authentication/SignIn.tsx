            ...
            <div className="flex flex-wrap items-center">
                <div className="hidden w-full xl:block xl:w-1/2">
                    <div className="py-17.5 px-26 text-center">
                        <p className="text-2xl px-20 font-bold text-black">
                            Fleet Journey
                        </p>
                        <p className="2xl:px-20">
                            Software created to simplify the process of recording business
                            trips made by TheGreenMile™ employees using their fleet of
                            electric cars.
                        </p>
