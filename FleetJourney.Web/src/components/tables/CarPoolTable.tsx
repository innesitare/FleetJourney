...
const CarPoolTable = () => {
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            <div className={`max-w-full overflow-x-auto ${isUpdateWindowVisible || isCreateWindowVisible  ? "blur" : ""}`}>
                    ...
                    {carData.map((car) => (
                        <tr key={car.id}>
                            <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                ...
                                <p className="text-sm">{car.id}</p>
                            </td>
                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className="text-black dark:text-white">{car.brand}</p>
                            </td>
                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className="text-black dark:text-white">{car.model}</p>
                            </td>
                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                            ...
                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className="text-black dark:text-white">
                                    {car.endOfLifeMileage} km
                                </p>
                            </td>
                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className="text-black dark:text-white">
                                    {car.maintenanceInterval} km
                                </p>
                            </td>
                            {authentication.isAuthenticated && (
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        ...
                        <td colSpan={7} className="py-5">
                            <div className="flex justify-center">
                                <button
                                    ...
                                    onClick={() => setIsCreateWindowVisible(true)}
                                >
                                    +
                                </button>
                            </div>
